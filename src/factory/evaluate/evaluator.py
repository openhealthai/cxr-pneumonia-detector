...
class Evaluator(Predictor):
    ...
    def __init__(self,
                 ...
                 class_thresholds=np.arange(0.05, 1.0, 0.05),
                 iou_thresholds=np.arange(0.4, 0.8, 0.05),
                 debug=False):
        
        super(Evaluator, self).__init__(dataset=dataset, predict_mode=False, debug=debug)
